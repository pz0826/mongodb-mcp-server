...
export const LogId = {
    ...
    shortestPathStart: mongoLogId(1_010_001),
    shortestPathComplete: mongoLogId(1_010_002),
    shortestPathError: mongoLogId(1_010_003),
    shortestPathGraphSize: mongoLogId(1_010_004),
    
    // Graph查询工具
    graphQueryStart: mongoLogId(1_011_001),
    graphQueryComplete: mongoLogId(1_011_002),
    graphQueryError: mongoLogId(1_011_003),
} as const;
